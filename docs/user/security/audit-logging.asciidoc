...
You can enable/disable audit logs, configure audit logs location, file/rolling file appenders and ignore filters using {ref}/security-settings-kb.html#audit-logging-settings[audit logging settings].
