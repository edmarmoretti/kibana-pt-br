...
spec:
  ...
  template:
    ...
    spec:
      ...
      #        wget -O - https://github.com/elastic/elastic-agent/archive/VERSION.tar.gz | tar xz -C /etc/elastic-agent/inputs.d --strip=5 "elastic-agent-main/deploy/kubernetes/elastic-agent/templates.d"
      #    volumeMounts:
